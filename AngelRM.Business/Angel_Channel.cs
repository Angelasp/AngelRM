...
{
   public class Angel_Channel
    {
     AngelData Adal = new AngelData("Angel_Channel", "Angel_Channel");
     public Angel_Channel()
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Model.Angel_Channel model)
        {
            return Adal.InsertObject<Model.Angel_Channel>(model);
        }
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.Angel_Channel model)
        {
            return Adal.UpdateObject<Model.Angel_Channel>(model);
        }

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public Model.Angel_Channel GetModel(string id)
        {
            return Adal.GetObject_ById<Model.Angel_Channel>(id);
        }
        /// <summary>
        /// 获得前几行数据
        /// </summary>
