...
{
    public class Angel_Content
    {

     AngelData Adal = new AngelData("Angel_Content", "Angel_Content");
     public Angel_Content()
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Model.Angel_Content model)
        {
            return Adal.InsertObject<Model.Angel_Content>(model);
        }
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.Angel_Content model)
        {
            return Adal.UpdateObject<Model.Angel_Content>(model);
        }

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public Model.Angel_Content GetModel(string id)
        {
            return Adal.GetObject_ById<Model.Angel_Content>(id);
        }
        /// <summary>
        /// 获得前几行数据
        /// </summary>
